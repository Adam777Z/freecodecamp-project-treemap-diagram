...
const KickstarterPledgesURL = './assets/json/kickstarter-funding-data.json';
const MovieSalesURL = './assets/json/movie-data.json';
const VideoGameSalesURL = './assets/json/video-game-sales-data.json';
